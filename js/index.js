...
$('.sl-mula li').bind('mouseenter', function () {
	$(this).addClass('on').siblings().removeClass('on');
	$(this).parent().parent().next(".sl-mb").find('ul').eq($(this).index()).show().siblings().hide();
});	
		   
$('.sl-oa-ula li').bind('mouseenter', function () {
	$(this).addClass('on').siblings().removeClass('on');
	$(".sl-oa-am").find('dl').eq($(this).index()).show().siblings().hide();
});	
